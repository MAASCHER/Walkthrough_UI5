		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Walkthrough",
									"targetURL": "#zeppelinwalkthrough-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zeppelinwalkthrough-display": {
								"semanticObject": "zeppelinwalkthrough",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zeppelin.walkthrough",
									"url": sap.ui.require.toUrl("zeppelin/walkthrough")
								}
							}
						}
					}
